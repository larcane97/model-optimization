...
class EfficientNetGenerator(GeneratorAbstract):
    ...
    def __call__(self,repeat:int=1):
        image_size, num_classes,dropout_rate,drop_connect_rate,model_name  = self.args
        module = EfficientNet.from_pretrained(
...
class MBConvBlock(nn.Module):
    ...
    def forward(self, inputs, drop_connect_rate:Optional[float]=None):
        ...
        if self.id_skip and self.stride == 1 and input_filters == output_filters:
            ...
            if isinstance(drop_connect_rate,float):
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        self.include_top = self._global_params.include_top
